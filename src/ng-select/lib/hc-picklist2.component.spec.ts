...
import { Component, ErrorHandler, NgZone, Type, ViewChild } from '@angular/core';
import { FormsModule } from '@angular/forms';
import { Subject } from 'rxjs';
import { MockNgZone } from '../testing/mocks';
import { selectOptions, TestsErrorHandler, tickAndDetectChanges } from '../testing/helpers';
...
describe('HcPicklist2Component', () => {
    ...
    describe('Model bindings and data changes', () => {
        let picklist: HcPicklist2Component;
...
class HcPicklist2TestCmp {
    @ViewChild(HcPicklist2Component, { static: false }) picklist: HcPicklist2Component;
    label = 'Yes';
